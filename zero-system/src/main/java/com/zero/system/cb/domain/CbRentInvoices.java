...
/**
 * 租金录入单据对象 cb_rent_invoices
 *
 * @author zhuxuguang
 * @date 2023-02-09
 */
public class CbRentInvoices extends BaseEntity
{
    ...
    @Excel(name = "摊销起始月份", width = 30, dateFormat = "yyyy-MM")
    private Date amortizeStartMonth;

    /** 摊销结束月份 */
    @JsonFormat(pattern = "yyyy-MM")
    @Excel(name = "摊销结束月份", width = 30, dateFormat = "yyyy-MM")
